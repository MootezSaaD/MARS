 ...
 */
    ...
    */
      ...
      // All need to be assigned even if not used by language (no gaps in array)
         ...
         styles[Token.COMMENT1] = new SyntaxStyle(new Color(0x558751),true,false);//(Color.black,true,false);
         styles[Token.COMMENT2] = new SyntaxStyle(new Color(0x990033),true,false);
         styles[Token.KEYWORD1] = new SyntaxStyle(new Color(0x94E4FF),false,false);//(Color.black,false,true);
